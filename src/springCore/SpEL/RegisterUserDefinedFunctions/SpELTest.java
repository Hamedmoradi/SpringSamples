package springCore.SpEL.RegisterUserDefinedFunctions;
...
public class SpELTest {
	public static void main(String[] args) throws SecurityException, NoSuchMethodException {
		...
		Integer len =  parser.parseExpression("#getStringLen('springCore.SpEL.RegisterUserDefinedFunctions')").getValue(seContext, Integer.class);
