...
/*
* On this page we will provide spring collection injection example with List, Set, Map and Properties.
* To populate values in the collection, spring provides different tags as follows.
1. <list> is for List
2. <set> is for Set
3. <map> is for Map
...
public class SpringDemo {
	public static void main(String[] args) {
		AbstractApplicationContext  context = new ClassPathXmlApplicationContext("springCore/collectionInjection/spring-config-1.xml");
